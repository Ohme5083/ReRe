...
{
    /// <inheritdoc />
    public partial class NouveauxModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Utilisateurs_RoleModels_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ressources_TypeModel_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commentaires_Commentaires_CommentaireId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RessourcesLikedId = table.Column<int>(type: "int", nullable: false),
                    UtilisateursId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RessourceModelUserModel", x => new { x.RessourcesLikedId, x.UtilisateursId });
                    table.ForeignKey(
                        name: "FK_RessourceModelUserModel_Ressources_RessourcesLikedId",
                        column: x => x.RessourcesLikedId,
                        principalTable: "Ressources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commentaires_CommentaireId",
                table: "Commentaires",
